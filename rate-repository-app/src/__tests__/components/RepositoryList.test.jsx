...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      expect(firstRepositoryItem).toHaveTextContent(repositories.edges[0].node.forksCount >= 1000 ? `${(repositories.edges[0].node.forksCount / 1000).toFixed(1)}k` : repositories.edges[0].node.forksCount);
      expect(firstRepositoryItem).toHaveTextContent(repositories.edges[0].node.stargazersCount >= 1000 ? `${(repositories.edges[0].node.stargazersCount / 1000).toFixed(1)}k` : repositories.edges[0].node.stargazersCount);
      ...
      expect(secondRepositoryItem).toHaveTextContent(repositories.edges[1].node.forksCount >= 1000 ? `${(repositories.edges[1].node.forksCount / 1000).toFixed(1)}k` : repositories.edges[1].node.forksCount);
      expect(secondRepositoryItem).toHaveTextContent(repositories.edges[1].node.stargazersCount >= 1000 ? `${(repositories.edges[1].node.stargazersCount / 1000).toFixed(1)}k` : repositories.edges[1].node.stargazersCount);
